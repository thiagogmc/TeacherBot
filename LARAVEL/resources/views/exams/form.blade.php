<div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
    <div class="col-md-6">
        ...
        <input class="form-control" name="date" type="date" id="date" value="{{ $exam->date or ''}}" >
    ...
    <div class="col-md-6">
        ...
        <textarea class="form-control" name="content" type="text" id="content" >{{ $exam->content or ''}}</textarea>
        {!! $errors->first('content', '<p class="help-block">:message</p>') !!}
    </div>
    <div class="col-md-6">
        <label for="subject">Valor</label>
        <input class="form-control" name="score" type="number" step=".01" value="{{ $exam->score or ''}}" id="score">
